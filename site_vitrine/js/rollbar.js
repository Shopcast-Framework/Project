var _rollbarConfig = {
    accessToken: "40e9ea2900a74f438407aa4d66069634",
...
! function(r)
{
...
}([function(r, o, t)
    {
        ...
        var e = t(1).Rollbar,
        n = t(2),
        i = "https://d37gvrvc0wt4s1.cloudfront.net/js/v1.7/rollbar.min.js";
            ...
            try
            {
                ...
                if (!r._wrapped)
                {
                    r._wrapped = function()
                    {
                        ...
                        {
                            throw o._rollbarContext = t() ||
                            {}, o._rollbarContext._wrappedSource = r.toString(), window._rollbarWrappedError = o, o
                        }
